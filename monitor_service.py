...
class Config:
    ...
    def __init__(self):
        ...
        self.categories = [
            "Commercial Driver License (CDL or CLP)",
            "Existing Driver License (renew, replace, update, or upgrade to REAL ID)",
            "First Driver License or Permit (age 18 or older)",
            "Medical Re-exam (NCDMV told you to come in)",
            "Motorcycle Endorsement",
            "Motorcycle Skills Test",
            "Out-of-State License Transfer",
            "State Identification Card (not a driver license)",
            "Teen Driver - Full Provisional License (under 18, Level 3)",
            "Teen Driver - Learner Permit (under 18, Level 1)",
            "Teen Driver - Road Test (under 18, Level 2)",
        ]

        self.category_map = {
            "Commercial Driver License (CDL or CLP)": "commercial_driver_license",
            "Existing Driver License (renew, replace, update, or upgrade to REAL ID)": "existing_driver_license",
            "First Driver License or Permit (age 18 or older)": "first_driver_license_or_permit",
            "Medical Re-exam (NCDMV told you to come in)": "medical_reexam",
            "Motorcycle Endorsement": "motorcycle_endorsement",
            "Motorcycle Skills Test": "motorcycle_skills_test",
            "Out-of-State License Transfer": "out_of_state_license_transfer",
            "State Identification Card (not a driver license)": "state_identification_card",
            "Teen Driver - Full Provisional License (under 18, Level 3)": "teen_driver_level_3",
            "Teen Driver - Learner Permit (under 18, Level 1)": "teen_driver_level_1",
            "Teen Driver - Road Test (under 18, Level 2)": "teen_driver_level_2",
        }
